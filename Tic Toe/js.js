...
function pegaQuadrado(id)
{
    ...
    if(clicado[id] == false)
    {
        ...
        {
            alert("Jogo encerrado. Clique no botão para iniciar um novo jogo!");
        }
        quemGanhou();
    }
}
